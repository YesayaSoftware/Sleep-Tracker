...
import software.yesaya.sleeptracker.databinding.FragmentSleepQualityBinding
...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        sleepQualityViewModel.navigateToSleepTracker.observe(this, Observer { observed ->
            if (observed == true) {
